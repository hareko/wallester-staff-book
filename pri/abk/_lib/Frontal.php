...
class Frontal {
   ...
   * 2 - other
   */
  private $tbn = 'contacts'; //table name
  private $fld = ['fname', 'lname', 'birth', 'gender', 'email', 'address']; //table fields */
   ...
   */ {
    ...
    ¤::$_->ts = [
        'asc' => '↑', /* sort ascending token */
        'dsc' => '↓', /* sort ascending token */
        'pgc' => 10 /* pagination size */
    ];
  }
